...
struct needle_def {
    int needle; // duh
    long correct_index; // index where this needle was located
...
typedef search_result (*int_search_func)(int const *const array, int size, int needle, int correct_index);
